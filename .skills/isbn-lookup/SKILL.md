...
- **Endpoint**：`POST https://app-d2yss59nidj5-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-d2yss59nidj5-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
