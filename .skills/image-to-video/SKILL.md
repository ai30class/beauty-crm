...
| Billing | The submit endpoint is billed per request; the query endpoint is free |
...
- **Billing**: The submit endpoint is billed per request; the query endpoint is free. Avoid unnecessary repeated submissions caused by parameter errors.
