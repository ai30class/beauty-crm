...
| Endpoint | `POST https://app-d2yss59nidj5-api-W9z3M74x6ZNL-gateway.appmiaoda.com/v1/code/send_message` |
| 认证模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| third_part_domain | `app-d2yss59nidj5-api-W9z3M74x6ZNL-gateway.appmiaoda.com` |
| 说明 | 用于向指定手机号发送短信验证码 |
...
async function sendSmsCode(
  ...
  const response = await fetch(
    "https://app-d2yss59nidj5-api-W9z3M74x6ZNL-gateway.appmiaoda.com/v1/code/send_message",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
